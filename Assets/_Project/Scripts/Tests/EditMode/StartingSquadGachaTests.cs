...
namespace FMLite.Tests
{
    public class StartingSquadGachaTests
    {
        ...
        public void T3_SameAbsoluteCA_DifferentTiersByReputation()
        {
            ...
            var (state1, club1) = BuildStateWithSingleClub(
                rep: 90,
                atLineCA: 120,
                otherLineCA: 130
            );
            ...
            var (state2, club2) = BuildStateWithSingleClub(
                rep: 50,
                atLineCA: 120,
                otherLineCA: 100
            );
        ...
        public void T5_Reroll_Determinism_AndFreshIds()
        {
            ...
            var e1 = StartingSquadGacha.RerollSquad(
                c1,
                s1,
                _leagueConfig,
                _balance,
            ...
            var e2 = StartingSquadGacha.RerollSquad(
                c2,
                s2,
                _leagueConfig,
                _balance,
            ...
            foreach (int oldId in beforeIds1)
                Assert.IsFalse(
                    c1.seniorSquadIds.Contains(oldId),
        ...
        public void T6_Reroll_NoTokens_Throws()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
                StartingSquadGacha.RerollSquad(
                    club,
                    state,
                    _leagueConfig,
                    _balance,
        ...
        public void T7_EmptyLine_ReturnsPoor()
        {
            ...
            var lb = new Player
            {
                id = nextId++,
                currentAbility = 100,
                info = new PersonalInfo { primaryPosition = Position.LB },
            };
            var cm = new Player
            {
                id = nextId++,
                currentAbility = 100,
                info = new PersonalInfo { primaryPosition = Position.CM },
            };
            var st = new Player
            {
                id = nextId++,
                currentAbility = 100,
                info = new PersonalInfo { primaryPosition = Position.ST },
            };
            state.AddPlayer(lb);
            state.AddPlayer(cm);
            state.AddPlayer(st);
