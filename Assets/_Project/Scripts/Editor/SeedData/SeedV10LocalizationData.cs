...
namespace FMLite.Editor
{
    public static class SeedV10LocalizationData
    {
        ...
        public static void Generate()
        {
            ...
            Debug.Log($"[SeedV10LocalizationData] {so.entries.Count} entries saved → {AssetPath}");
        }
        ...
        private static List<LocalizationEntry> BuildV10CompletedSceneLabels() =>
            new List<LocalizationEntry>
            {
                ...
                E(
                    "btn_accept_transfer_list",
                    "수락 (이적 리스트 등재)",
                    "Accept (List for Transfer)"
                ),
                ...
                // 전술 성향 (TacticLineupController.MentalityKeys)
                E("mentality_very_defensive", "매우 수비적", "Very Defensive"),
                E("mentality_defensive", "수비적", "Defensive"),
                E("mentality_cautious", "신중한", "Cautious"),
                E("mentality_balanced", "균형", "Balanced"),
                E("mentality_positive", "적극적", "Positive"),
                E("mentality_attacking", "공격적", "Attacking"),
                E("mentality_very_attacking", "매우 공격적", "Very Attacking"),
            };
        ...
        private static List<LocalizationEntry> BuildV05Entries() =>
            new List<LocalizationEntry>
            {
                ...
                E("facility_upgrade_cost_fmt", "업그레이드 {0} ({1}일)", "Upgrade {0} ({1} days)"),
                ...
                E("facility_effect_scout_fmt", "명단 {0}명 · ±{1} CA", "List {0} · ±{1} CA"),
                E("facility_effect_training_fmt", "훈련 효율 ×{0}", "Training ×{0}"),
                E(
                    "facility_effect_youth_coach_fmt",
                    "유스 +{0} PA · 트레잇 {1}%",
                    "Youth +{0} PA · Trait {1}%"
                ),
                E("facility_effect_youth_recruitment_fmt", "풀 {0}명", "Pool {0}"),
                E("facility_effect_youth_facility_fmt", "유스 성장 ×{0}", "Youth Growth ×{0}"),
                E(
                ...
                E("facility_effect_gym_fmt", "피지컬 성장 ×{0}", "Physical ×{0}"),
                ...
                E("state_injury_return_fmt", "부상: 복귀 예정 {0}", "Injury: Expected return {0}"),
                ...
                E("interview_promise_playtime", "출전시간 보장하겠다", "Promise more playing time"),
                E(
                ...
                // 페널티
                E("match_penalty_awarded_fmt", "페널티킥! ({minute}')", "Penalty! ({minute}')"),
                E(
        ...
        private static List<LocalizationEntry> BuildV10MatchEvents() =>
            new List<LocalizationEntry>
            {
                ...
                E(
                    "match_event_goal_5",
                    "{player}의 장거리 폭격이 골망을 흔든다!",
                    "{player} unleashes a thunderbolt from distance!"
                ),
                // ── KeyPass / Assist (5) ─────────────────────────────
                E(
                    "match_event_keypass_1",
                    "{player}의 절묘한 스루패스!",
                    "A defence-splitting pass from {player}!"
                ),
                E(
                    "match_event_keypass_2",
                    "{player}가 박스 안으로 정확한 크로스!",
                    "{player} whips in a perfect cross!"
                ),
                E(
                    "match_event_keypass_3",
                    "{player}의 환상적인 키패스!",
                    "A sublime key pass from {player}!"
                ),
                E(
                    "match_event_keypass_4",
                    "{player}의 백힐로 찬스 메이킹!",
                    "{player} backheels it into space!"
                ),
                E(
                    "match_event_keypass_5",
                    "{player}의 노룩 패스가 찬스를 만든다!",
                    "{player} with a no-look pass to create the chance!"
                ),
                // ── Save (5) ─────────────────────────────────────────
                E("match_event_save_1", "{gk}의 슈퍼 세이브!", "Brilliant save by {gk}!"),
                E(
                    "match_event_save_2",
                    "{gk}가 가까스로 펀칭!",
                    "{gk} punches it clear at full stretch!"
                ),
                E("match_event_save_3", "{gk}의 다이빙 캐치!", "{gk} dives to gather it safely!"),
                E(
                    "match_event_save_4",
                    "{gk}가 발로 막아냈다!",
                ...
                // ── Shot On Target (4) ───────────────────────────────
                E(
                    "match_event_shoton_1",
                    "{player}의 슛이 골키퍼 정면!",
                    "{player}'s shot is straight at the keeper."
                ),
                E(
                    "match_event_shoton_2",
                    "{player}의 슛, 골대 맞고 튕겨나온다!",
                    "{player} hits the woodwork!"
                ),
                E(
                    "match_event_shoton_3",
                    "{player}의 강슛, 골키퍼가 쳐낸다!",
                    "{player}'s fierce strike — pushed away!"
                ),
                E(
                    "match_event_shoton_4",
                    "{player}의 슛이 골라인 위에서 클리어!",
                    "Cleared off the line from {player}'s effort!"
                ),
                // ── Shot Off Target (3) ──────────────────────────────
                E(
                    "match_event_shotoff_1",
                    "{player}의 슛이 크로스바를 살짝 넘긴다!",
                    "{player}'s shot flies just over the bar!"
                ),
                E(
                    "match_event_shotoff_2",
                    "{player}의 슛이 옆그물!",
                    "{player} sends it wide of the post!"
                ),
                E(
                    "match_event_shotoff_3",
                    "{player}의 위협적인 슛이 빗나간다!",
                    "{player}'s effort goes narrowly wide!"
                ),
                // ── Yellow Card (3) ──────────────────────────────────
                E(
                    "match_event_yellow_1",
                    "{player}, 거친 태클로 경고!",
                    "{player} is booked for a reckless challenge!"
                ),
                E(
                    "match_event_yellow_2",
                    "{player}, 항의로 옐로카드!",
                    "{player} sees yellow for dissent."
                ),
                E(
                    "match_event_yellow_3",
                    "{player}, 시간 지연으로 경고!",
                ...
                // ── Second Yellow → Red (2) ──────────────────────────
                E(
                    "match_event_2nd_yellow_1",
                    "{player}, 두 번째 경고 — 퇴장!",
                    "Two yellows — {player} is off!"
                ),
                E(
                    "match_event_2nd_yellow_2",
                    "{player}가 어리석은 반칙으로 두 번째 옐로!",
                    "A foolish foul earns {player} a second yellow!"
                ),
                // ── Foul (3) ─────────────────────────────────────────
                E("match_event_foul_1", "{player}가 반칙을 범한다.", "{player} concedes a foul."),
                E(
                    "match_event_foul_2",
                    "{player}의 격한 태클로 휘슬!",
                ...
                E("match_event_kickoff_2", "후반전 시작!", "Second half is underway!"),
                E("match_event_kickoff_3", "연장 전반전 시작!", "First half of extra time begins!"),
                E(
                    "match_event_kickoff_4",
                    "연장 후반전 시작!",
                    "Second half of extra time begins!"
                ),
                // ── Half Time (3) ────────────────────────────────────
                E("match_event_halftime_1", "전반 종료 휘슬.", "Whistle blows for half-time."),
                E(
                    "match_event_halftime_2",
                    "휘슬 — 라커룸으로 향한다.",
                    "Half-time — teams head to the dressing room."
                ),
                E(
                    "match_event_halftime_3",
                    "전반 종료 — 점수는 {homeScore}-{awayScore}.",
                    "Half-time — score is {homeScore}-{awayScore}."
                ),
                // ── Full Time (4) ────────────────────────────────────
                E("match_event_fulltime_1", "경기 종료!", "Full time!"),
                E(
                    "match_event_fulltime_2",
                    "최종 휘슬 — {homeScore}-{awayScore}.",
                    "Final whistle — {homeScore}-{awayScore}."
                ),
                E(
                    "match_event_fulltime_3",
                    "경기 종료 — 결과 확정.",
                    "It's all over — the result is final."
                ),
                E("match_event_fulltime_4", "마지막 휘슬이 울린다.", "The final whistle blows."),
                // ── Extra Time Start (2) ─────────────────────────────
                E("match_event_et_start_1", "연장전 돌입!", "Heading to extra time!"),
                E(
                    "match_event_et_start_2",
                    "정규 시간 무승부 — 연장전 시작.",
        ...
        private static List<LocalizationEntry> BuildV10OptionsAndInbox() =>
            new List<LocalizationEntry>
            {
                ...
                E(
                    "pnego_empty",
                    "진행 중인 개인 협상이 없습니다",
                    "No ongoing personal negotiations"
                ),
        ...
        private static List<LocalizationEntry> BuildV10CurrencySynergyCupTraining() =>
            new List<LocalizationEntry>
            {
                ...
                E(
                    "synergy_big_and_small_desc",
                    "장신 스트라이커 + 단신 윙어 조합. 헤더골 +10% / 크로스 결정 +10%.",
                ...
                E(
                    "synergy_target_speedster_desc",
                    "타겟맨 스트라이커 + 빠른 윙어. 카운터 어택 +15%.",
                    "Target Man with pacy wingers. +15% counter attacks."
                ),
                E("synergy_possession_name", "온볼이마이웨이", "Possession"),
                E(
                    "synergy_possession_desc",
                    "패스 + 비전 좋은 미드필더 2명. 점유율 +5% / 패스 성공 +5%.",
                ...
                E(
                    "training_individual_full",
                    "훈련 인원 초과 — 시설 업그레이드 필요",
